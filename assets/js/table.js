    ...
    var methods = {
        ...
        contextMenu : function(type, number, e) {
            ...
            if (type == 'col') {
                ...
                // 
                contextMenuContent += "<div class='example-context-menu'>";
      contextMenuContent += "  <a class='example-option'>Alignment<span></span></a>";
      contextMenuContent += "  <div class='sub-menu'>";
      contextMenuContent += "    <a onclick=\"handleAlignmentOption('" + $.fn.jexcel.current + "', 'right')\">Right</a>";
      contextMenuContent += "    <a onclick=\"handleAlignmentOption('" + $.fn.jexcel.current + "', 'center')\">Center</a>";
      contextMenuContent += "    <a onclick=\"handleAlignmentOption('" + $.fn.jexcel.current + "', 'left')\">Left</a>";
