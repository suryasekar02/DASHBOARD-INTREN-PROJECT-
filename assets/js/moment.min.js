!(function (e, t) {
      ...
      if ((null != c.deprecationHandler && c.deprecationHandler(null, r), o)) {
        for (var e, t, n = [], s = arguments.length, i = 0; i < s; i++) {
          if (((e = ""), "object" == typeof arguments[i])) {
            for (t in ((e += "\n[" + i + "] "), arguments[0]))
              f(arguments[0], t) && (e += t + ": " + arguments[0][t] + ", ");
            e = e.slice(0, -2);
          } else e = arguments[i];
          n.push(e);
        }
  ...
  function z(t, n) {
    return function (e) {
      return null != e
        ? (q(this, t, e), c.updateOffset(this, n), this)
        : $(this, t);
    };
  }
  function $(e, t) {
  ...
  function q(e, t, n) {
    e.isValid() &&
      !isNaN(n) &&
      ("FullYear" === t && I(e.year()) && 1 === e.month() && 29 === e.date()
        ? ((n = Z(n)),
  ...
  function Ie(e, t, n) {
    ...
    return (
      r < 1
        ? (s = r + je((i = e.year() - 1), t, n))
        : r > je(e.year(), t, n)
        ? ((s = r - je(e.year(), t, n)), (i = e.year() + 1))
        : ((i = e.year()), (s = r)),
      { week: s, year: i }
    );
  }
  ...
  function ut(e) {
    for (var t, n, s, i, r = 0; r < e.length; ) {
      for (
        t = (i = ot(e[r]).split("-")).length,
          n = (n = ot(e[r + 1])) ? n.split("-") : null;
        0 < t;
    ...
    return (
      t &&
        ...
        ((t =
          t[ve] < 0 || 11 < t[ve]
            ? ve
            : t[ke] < 1 || t[ke] > xe(t[pe], t[ve])
            ? ke
            : t[Me] < 0 ||
              24 < t[Me] ||
              (24 === t[Me] && (0 !== t[De] || 0 !== t[Se] || 0 !== t[Ye]))
            ? Me
            : t[De] < 0 || 59 < t[De]
            ? De
            : t[Se] < 0 || 59 < t[Se]
            ...
            ? Ye
            : -1),
        _(e)._overflowDayOfYear && (t < pe || ke < t) && (t = ke),
        _(e)._overflowWeeks && -1 === t && (t = Oe),
        _(e)._overflowWeekday && -1 === t && (t = be),
        (_(e).overflow = t)),
      e
    );
  }
  ...
  function St(e) {
    ...
    r
      ? ((t = Dt(r[4], r[3], r[2], r[5], r[6], r[7])),
        (n = r[1]),
        (s = t),
        (i = e),
        n && $e.indexOf(n) !== new Date(s[0], s[1], s[2]).getDay()
          ...
          : ((e._a = t),
            (e._tzm =
              ...
              i
                ...
                : t
                ? 0
                : 60 * (((t = parseInt(r, 10)) - (r = t % 100)) / 100) + r)),
    ...
    if (!e._d) {
      for (
        i = e,
          ...
          e._w &&
            ...
            (function (e) {
              ...
              null != (t = e._w).GG || null != t.W || null != t.E
                ? ((r = 1),
                  (a = 4),
                  (n = Yt(t.GG, e._a[pe], Ie(Nt(), 1, 4).year)),
                  (s = Yt(t.W, 1)),
                  ((i = Yt(t.E, 1)) < 1 || 7 < i) && (o = !0))
                : ((r = e._locale._week.dow),
                  (a = e._locale._week.doy),
                  (u = Ie(Nt(), r, a)),
                  (n = Yt(t.gg, e._a[pe], u.year)),
                  (s = Yt(t.w, u.week)),
                  null != t.d
                    ? ((i = t.d) < 0 || 6 < i) && (o = !0)
                    : null != t.e
                    ? ((i = t.e + r), (t.e < 0 || 6 < t.e) && (o = !0))
                    : (i = r));
              s < 1 || s > je(n, r, a)
          ...
          null != e._dayOfYear &&
            ((s = Yt(e._a[pe], n[pe])),
            (e._dayOfYear > Fe(s) || 0 === e._dayOfYear) &&
      ...
      24 === e._a[Me] &&
        ...
        (e._d = (e._useUTC ? Ge : Ve).apply(null, a)),
    ...
    if (e._f !== c.ISO_8601)
      if (e._f !== c.RFC_2822) {
        ...
        for (
          ...
          (n = l[d]),
            (t = (a.match(ce(n, e)) || [])[0]) &&
              (0 < (i = a.substr(0, a.indexOf(t))).length &&
            ...
            W[n]
              ? (t ? (_(e).empty = !1) : _(e).unusedTokens.push(n),
                (s = n),
                (r = e),
                null != (i = t) && f(_e, s) && _e[s](i, r._a, r, s))
              : e._strict && !t && _(e).unusedTokens.push(n);
        (_(e).charsLeftOver = o - u),
          0 < a.length && _(e).unusedInput.push(a),
          e._a[Me] <= 12 &&
            !0 === _(e).bigHour &&
            0 < e._a[Me] &&
            (_(e).bigHour = void 0),
          ...
          (e._a[Me] = (function (e, t, n) {
            ...
            return null != e.meridiemHour
              ? e.meridiemHour(t, n)
              : null != e.isPM
              ? ((n = e.isPM(n)) && t < 12 && (t += 12),
                (t = n || 12 !== t ? t : 0))
              : t;
          })(e._locale, e._a[Me], e._meridiem)),
          null !== (o = _(e).era) &&
            (e._a[pe] = e._locale.erasConvertYear(o, e._a[pe])),
          Ot(e),
          ft(e);
      } else St(e);
    else Mt(e);
            ...
            : (s(t)
                ...
                ? (function (e) {
                    var t,
                      ...
                      u = e._f.length;
                    if (0 === u)
                      return (_(e).invalidFormat = !0), (e._d = new Date(NaN));
                    for (i = 0; i < u; i++)
                      (r = 0),
                        (a = !1),
                        (t = p({}, e)),
  ...
  function Ut(e) {
    ...
    (this._isValid = (function (e) {
      var t,
        ...
        i = Ct.length;
      for (t in e)
        if (f(e, t) && (-1 === we.call(Ct, t) || (null != e[t] && isNaN(e[t]))))
          return !1;
      for (n = 0; n < i; ++n)
        if (e[Ct[n]]) {
          if (s) return !1;
      ...
      (this._milliseconds = +e + 1e3 * l + 6e4 * u + 1e3 * o * 60 * 60),
      (this._days = +a + 7 * r),
  ...
  function Et(e, t) {
    ...
    return t._isUTC
      ? ((n = t.clone()),
        (t = (k(e) || s(e) ? e : Nt(e)).valueOf() - n.valueOf()),
    ...
    return (
      Ht(e)
        ...
        : "object" == typeof s &&
          ...
          (s.M = n.months)),
      (s = new Ut(s)),
      Ht(e) && f(e, "_locale") && (s._locale = e._locale),
      Ht(e) && f(e, "_isValid") && (s._isValid = e._isValid),
      s
    );
  }
  function $t(e, t) {
  ...
  function tn(e) {
    return void 0 === e
      ? this._locale._abbr
      : (null != (e = ct(e)) && (this._locale = e), this);
  }
  ...
  (ie.add = Qt),
      ...
      switch (((n = this._isUTC ? on : an), e)) {
        ...
        case "hour":
          (t = this._d.valueOf()),
            (t +=
              36e5 -
              rn(t + (this._isUTC ? 0 : 6e4 * this.utcOffset()), 36e5) -
              1);
          break;
        case "minute":
    ...
    (ie.from = function (e, t) {
      return this.isValid() && ((k(e) && e.isValid()) || Nt(e).isValid())
      ...
      if ("object" == typeof e)
        for (
          var n = (function (e) {
              var t,
                n = [];
              for (t in e) f(e, t) && n.push({ unit: t, priority: E[t] });
              return (
                n.sort(function (e, t) {
    ...
    (ie.startOf = function (e) {
      ...
      switch (((n = this._isUTC ? on : an), e)) {
        ...
        case "hour":
          (t = this._d.valueOf()),
            (t -= rn(t + (this._isUTC ? 0 : 6e4 * this.utcOffset()), 36e5));
          break;
        case "minute":
    ...
    (ie.hour = ie.hours = nt),
    (ie.minute = ie.minutes = Te),
    (ie.second = ie.seconds = ze),
    (ie.millisecond = ie.milliseconds = qe),
    ...
    (ie.months = n("months accessor is deprecated. Use month instead", Ue)),
    (ie.years = n("years accessor is deprecated. Use year instead", Le)),
    (ie.zone = n(
  ...
  (X.calendar = function (e, t, n) {
    return Y((e = this._calendar[e] || this._calendar.sameElse))
      ? e.call(t, n)
      : e;
  }),
    ...
    (X.pastFuture = function (e, t) {
      return Y((e = this._relativeTime[0 < e ? "future" : "past"]))
        ? e(t)
        : e.replace(/%s/i, t);
    }),
    (X.set = function (e) {
      var t, n;
      for (n in e)
        f(e, n) && (Y((t = e[n])) ? (this[n] = t) : (this["_" + n] = t));
      (this._config = e),
    ...
    (X.eras = function (e, t) {
      for (
        var n, s = this._eras || ct("en")._eras, i = 0, r = s.length;
        i < r;
        ++i
      )
        switch (
          ("string" == typeof s[i].since &&
            ((n = c(s[i].since).startOf("day")), (s[i].since = n.valueOf())),
          typeof s[i].until)
        ) {
          case "undefined":
            s[i].until = 1 / 0;
            break;
          case "string":
            (n = c(s[i].until).startOf("day").valueOf()),
              (s[i].until = n.valueOf());
        }
      return s;
    }),
    ...
    (X.erasConvertYear = function (e, t) {
      ...
      return void 0 === t
        ? c(e.since).year()
        : c(e.since).year() + (t - e.offset) * n;
    }),
    (X.erasAbbrRegex = function (e) {
      return (
        f(this, "_erasAbbrRegex") || ln.call(this),
        e ? this._erasAbbrRegex : this._erasRegex
      );
    }),
    (X.erasNameRegex = function (e) {
      return (
        f(this, "_erasNameRegex") || ln.call(this),
        e ? this._erasNameRegex : this._erasRegex
      );
    }),
    (X.erasNarrowRegex = function (e) {
      return (
        f(this, "_erasNarrowRegex") || ln.call(this),
    ...
    (X.monthsParse = function (e, t, n) {
      ...
      if (this._monthsParseExact)
        return function (e, t, n) {
          ...
          return n
            ? "MMM" === t
              ? -1 !== (i = we.call(this._shortMonthsParse, e))
                ? i
                : null
              : -1 !== (i = we.call(this._longMonthsParse, e))
              ? i
              : null
            : "MMM" === t
            ? -1 !== (i = we.call(this._shortMonthsParse, e)) ||
    ...
    (X.monthsRegex = function (e) {
      return this._monthsParseExact
        ? (f(this, "_monthsRegex") || He.call(this),
          e ? this._monthsStrictRegex : this._monthsRegex)
        : (f(this, "_monthsRegex") || (this._monthsRegex = We),
    ...
    (X.monthsShortRegex = function (e) {
      return this._monthsParseExact
        ...
        : (f(this, "_monthsShortRegex") || (this._monthsShortRegex = Re),
    ...
    (X.weekdays = function (e, t) {
      return (
        ...
        !0 === e ? Ze(t, this._week.dow) : e ? t[e.day()] : t
      );
    }),
    ...
    (X.weekdaysParse = function (e, t, n) {
      ...
      if (this._weekdaysParseExact)
        return function (e, t, n) {
          ...
          return n
            ? "dddd" === t
              ? -1 !== (i = we.call(this._weekdaysParse, e))
                ? i
                : null
              : "ddd" === t
              ? -1 !== (i = we.call(this._shortWeekdaysParse, e))
                ? i
                : null
              : -1 !== (i = we.call(this._minWeekdaysParse, e))
              ? i
              : null
            : "dddd" === t
            ? -1 !== (i = we.call(this._weekdaysParse, e)) ||
    ...
    (X.weekdaysRegex = function (e) {
      return this._weekdaysParseExact
        ? (f(this, "_weekdaysRegex") || Xe.call(this),
          e ? this._weekdaysStrictRegex : this._weekdaysRegex)
        : (f(this, "_weekdaysRegex") || (this._weekdaysRegex = Be),
    ...
    (X.weekdaysShortRegex = function (e) {
      return this._weekdaysParseExact
        ...
        : (f(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = Je),
    ...
    (X.weekdaysMinRegex = function (e) {
      return this._weekdaysParseExact
        ...
        : (f(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = Qe),
    ...
    (c.lang = n("moment.lang is deprecated. Use moment.locale instead.", ht)),
    (c.langData = n(
  ...
  return (
    ...
    (X.as = function (e) {
      ...
      if ("month" === (e = V(e)) || "quarter" === e || "year" === e)
        switch (((t = this._days + s / 864e5), (n = this._months + kn(t)), e)) {
          case "month":
            return n;
          case "quarter":
            return n / 3;
        ...
        null != t
          ? ((s = it),
            null != rt[e] && null != rt[e].parentLocale
              ? rt[e].set(O(rt[e]._config, t))
              : ((t = O((s = null != (n = lt(e)) ? n._config : s), t)),
                null == n && (t.abbr = e),
                ((t = new b(t)).parentLocale = rt[e]),
                (rt[e] = t)),
            ht(e))
          : null != rt[e] &&
            (null != rt[e].parentLocale
              ? ((rt[e] = rt[e].parentLocale), e === ht() && ht(e))
